...
inline unsigned short getrs1(unsigned int inst){
unsigned short rs1=inst%(2<<19)/(2<<14);
return rs1;
}

inline unsigned short getrs2(unsigned int inst){
unsigned short rs2=inst%(2<<24)/(2<<19);
return rs2;
}

inline unsigned short getfunc3(unsigned int inst){
unsigned short func3=inst%(2<<14)/(2<<11);
return func3;
}

inline unsigned short getfunc7(unsigned int inst){
unsigned short func7=inst>>25;
return func7;
}

inline unsigned short getrd(unsigned int inst){
unsigned short rd=inst%(2<<11)/(2<<6);
return rd;
}
inline unsigned int getinst(char* temp){
